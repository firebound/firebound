...
public partial class CharacterGridCellComponent : Node3D {
    ...
    private void UpdateCharacter() {
        ...
        if (hasCharacter) {
            ...
            else if (_characterEntity.CharacterData != _cellData.Character) {            // Only update if the character data is actually different
    ...
    private void CreateCharacterEntity() {
        ...
        if (_cellData?.Character != null) {        _characterEntity.Data = _cellData.Character; // This might trigger EntityUpdated
    }
        else {
