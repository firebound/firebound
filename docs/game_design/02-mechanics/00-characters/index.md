...
Esta seção apresenta um resumo das principais mecânicas que definem os personagens do jogo.

## Atributos

Os personagens possuem atributos básicos, como vida, força e defesa, que determinam seu desempenho em combate e outras situações. Os valores iniciais variam conforme os arquétipos e papéis (role) dos personagens.
...
Esses arquétipos definem as habilidades, atributos e equipamentos iniciais, que determinam a função do personagem na equipe.
...
> Exemplo: O personagem morto se transforma em um item "Restos mortais", que pode ser usado para reviver o personagem na "enfermaria" da aldeia.
